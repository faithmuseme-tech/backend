...
from .views import (
    ...
    AdminRoomTransferView, ChatAssigneesView,
...
urlpatterns = [
    ...
    path('admin/rooms/<int:room_id>/transfer/', AdminRoomTransferView.as_view(), name='admin_chat_transfer'),
    path('admin/unread/',                     AdminUnreadTotalView.as_view(),   name='admin_chat_unread'),
    path('admin/assignees/',                  ChatAssigneesView.as_view(),      name='chat_assignees'),
]
