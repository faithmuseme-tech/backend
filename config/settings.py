...
DEBUG = True  # TEMP: debug 500 on Railway — revert after fix

ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,web-production-1643f.up.railway.app').split(',')
